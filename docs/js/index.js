...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_dark_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/dark.js */ \"./src/js/modules/dark.js\");\n/* harmony import */ var _modules_startload_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/startload.js */ \"./src/js/modules/startload.js\");\n/* harmony import */ var _modules_triangle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/triangle.js */ \"./src/js/modules/triangle.js\");\n/* harmony import */ var _modules_hsla_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/hsla.js */ \"./src/js/modules/hsla.js\");\n/* harmony import */ var _modules_skill_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/skill.js */ \"./src/js/modules/skill.js\");\n/* harmony import */ var _modules_youtubeAPI_youtubeAPI_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/youtubeAPI/youtubeAPI.js */ \"./src/js/modules/youtubeAPI/youtubeAPI.js\");\n\n\n\n\n\n\n\n\n(0,_modules_dark_js__WEBPACK_IMPORTED_MODULE_0__.darkFunction)();\n(0,_modules_startload_js__WEBPACK_IMPORTED_MODULE_1__.startloadFunction)();\n(0,_modules_triangle_js__WEBPACK_IMPORTED_MODULE_2__.triangleFunction)();\n(0,_modules_hsla_js__WEBPACK_IMPORTED_MODULE_3__.hslaFunction)();\n(0,_modules_skill_js__WEBPACK_IMPORTED_MODULE_4__.skillFunction)();\n(0,_modules_youtubeAPI_youtubeAPI_js__WEBPACK_IMPORTED_MODULE_5__.youtubeAPIFunction)();\n\n//# sourceURL=webpack://aaa/./src/js/index.js?");

/***/ }),

/***/ "./src/js/modules/dark.js":
/*!********************************!*\
  !*** ./src/js/modules/dark.js ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"darkFunction\": function() { return /* binding */ darkFunction; }\n/* harmony export */ });\n //ダークモード切り替え\n\n/**\n * https://developer.mozilla.org/ja/docs/Web/API/MediaQueryList\n * mediaQueryListを取得\n */\n\nvar darkFunction = function darkFunction() {\n  var darkCheck = document.querySelector('[data-dark=\"dark\"]');\n\n  var darkOn = function darkOn() {\n    document.body.classList.remove('light-mode');\n    document.body.classList.add('dark-mode');\n    darkCheck.checked = true;\n  };\n\n  var darkOff = function darkOff() {\n    document.body.classList.remove('dark-mode');\n    document.body.classList.add('light-mode');\n    darkCheck.checked = false;\n  }; //ダークモード自動切り替え\n\n\n  var darkMode = matchMedia('(prefers-color-scheme:dark)').matches;\n  darkMode ? darkOn() : darkOff(); //ダークモード手動切り替え\n\n  darkCheck.addEventListener('change', function () {\n    return darkCheck.checked ? darkOn() : darkOff();\n  });\n};\n\n//# sourceURL=webpack://aaa/./src/js/modules/dark.js?");

/***/ }),

/***/ "./src/js/modules/hsla.js":
/*!********************************!*\
  !*** ./src/js/modules/hsla.js ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"hslaFunction\": function() { return /* binding */ hslaFunction; }\n/* harmony export */ });\n\n/**\n * hslと色相の考え方\n * https://qiita.com/clockmaker/items/66cd8c88dade24c3fb8f\n * https://www.colorzilla.com/gradient-editor/\n * https://cssgradient.io/\n */\n\nvar hslaFunction = function hslaFunction() {\n  var header = document.querySelector('#header');\n  var num = 64;\n\n  var hsl = function hsl() {\n    return \"linear-gradient(135deg, hsla(\".concat(num, \",100%,75%,1) 0%,hsla(\").concat(num + 164, \" ,83%,70%,1) 50%,hsla(\").concat(num + 239, \",40%,47%,1) 100%)\");\n  }; //スクロールで変化\n\n\n  addEventListener('scroll', function (e) {\n    num += Math.floor(scrollY % 10);\n    header.style.backgroundImage = hsl();\n  }); //時間で変化\n\n  var timeColor = function timeColor() {\n    requestAnimationFrame(timeColor);\n    num += .3;\n    header.style.backgroundImage = hsl();\n  };\n\n  timeColor();\n};\n\n//# sourceURL=webpack://aaa/./src/js/modules/hsla.js?");
